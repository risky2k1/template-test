                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="mb-5">
                                    <select name="timezone" aria-label="Select a Timezone"
                                            ...
                                            data-select2-id="select2-data-1-tm9u" tabindex="-1"
                                            aria-hidden="true" data-kt-initialized="1">
                                        <option value="next" data-select2-id="select2-data-3-het0">Within the
                                            next
                                        </option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-2-zhns"
                                        style="width: 100%;"><span class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false"
                                                tabindex="0" aria-disabled="false"
                                                aria-labelledby="select2-timezone-ht-container"
                                                aria-controls="select2-timezone-ht-container"><span
                                                    class="select2-selection__rendered"
                                                    id="select2-timezone-ht-container" role="textbox"
                                                    aria-readonly="true"
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-6">
                                        <select name="date_typer" aria-label="Select a Timezone"
                                                ...
                                                class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                                                data-select2-id="select2-data-4-ynel" tabindex="-1"
                                                aria-hidden="true" data-kt-initialized="1">
                                            <option value="days" data-select2-id="select2-data-6-sgc4">Days
                                            </option>
                                            ...
                                            class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-5-nc6e"
                                            style="width: 100%;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-date_typer-hp-container"
                                                    aria-controls="select2-date_typer-hp-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-date_typer-hp-container" role="textbox"
