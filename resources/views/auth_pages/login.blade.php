<html lang="en" data-bs-theme="light"><!--begin::Head--><head><base href="../../../">
        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    <!--begin::Form-->
                    <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"  action="{{route('login')}} "  method="POST">
                        @csrf
                        <!--begin::Heading-->
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
            ...
            <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                ...
                <a href="../../demo1/dist/index.html" class="mb-0 mb-lg-12">
                    <img alt="Logo" src="a{{asset('ssets/media/logos/custom-1.pn')}}g" class="h-60px h-lg-75px">
                </a>
                <!--end::Logo-->
                <!--begin::Image-->
